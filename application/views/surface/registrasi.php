                               ...
                               <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                       <div class="col">
                                           ...
                                           <input type="text" name="rm" class="form-control datepicker bg-grey border-1 small" placeholder="Masukan Kode Rekam Medis..." autocomplete="off" required>
                               ...
                               <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                       <div class="col">
                                           ...
                                           <input type="text" name="nama_pasien" class="form-control datepicker bg-grey border-1 small" placeholder="Masukan Nama Pasien..." autocomplete="off" required>
                                           <span class="text-danger ">wajib diisi</span>
                                       </div>
                                   </div>
                               </div>
                                   ...
                                   <div class="row no-gutters align-items-center">
                                       <div class="col">
                                           <div class="form-group">
                                               ...
                                               <select id="kategori_pasien" name="kategori_pasien" class="form-control" required>
                               ...
                               <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                       <div class="col">
                                           ...
                                           <input type="date" id="tgl_lahir" name="tgl_lahir" class="form-control datepicker bg-grey border-1 small" placeholder="Masukan Tanggal Lahir...">
                                       </div>
                                   </div>
                               </div>
                           </div>
                               ...
                               <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                       <div class="col">
                                           ...
                                           <input type="text" id="nomor_hp" name="nomor_hp" class="form-control datepicker bg-grey border-1 small" placeholder="Masukan Nomor Hp..." autocomplete="off">
                                           <h5 class="text-danger mt-1 ml-2">use +62</h5>
                                       </div>
                                   </div>
                               </div>
                           </div>
                               ...
                               <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                       <div class="col">
                                           ...
                                           <input type="text" id="pekerjaan" name="pekerjaan" class="form-control datepicker bg-grey border-1 small" placeholder="Masukan Data Pekerjaan..." autocomplete="off">
                                       </div>
                                   </div>
                               </div>
                           </div>
                               ...
                               <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                       <div class="col">
                                           ...
                                           <input type="text" id="no_kk" name="no_kk" class="form-control datepicker bg-grey border-1 small" placeholder="Masukan Nomor KK..." autocomplete="off">
                                       </div>
                                   </div>
                               </div>
                           </div>
                               ...
                               <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                       <div class="col">
                                           ...
                                           <input type="text" id="nama_ayah" name="nama_ayah" class="form-control datepicker bg-grey border-1 small" placeholder="Masukan Nama Ayah..." autocomplete="off">
                                       </div>
                                   </div>
                               </div>
                           </div>
                               ...
                               <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                       <div class="col">
                                           ...
                                           <input type="text" id="nama_ibu" name="nama_ibu" class="form-control datepicker bg-grey border-1 small" placeholder="Masukan Nama Ibu..." autocomplete="off">
                                       </div>
                                   </div>
                               </div>
                           </div>
                               ...
                               <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                       <div class="col">
                                           ...
                                           <input type="text" id="alamat" name="alamat" class="form-control datepicker bg-grey border-1 small" placeholder="Masukan Alamat..." autocomplete="off">
                                       </div>
                                   </div>
                               </div>
                           </div>
